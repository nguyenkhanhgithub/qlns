...
class CalClassController extends Controller
{
    //    //
    public function index()
    {
        ...
        $lop = Lop::all();
        # code...
        return view('Lichtuan.Lich.LichLop',['thu' => $thu,'monhoc' => $monhoc, 'giaovien' => $giaovien ,'tiethoc' => $tiethoc, 'tuanhoc' => $tuanhoc,'max_date' => $max_date,'lop' => $lop]);
    }
}
