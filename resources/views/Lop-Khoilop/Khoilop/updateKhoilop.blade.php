    ...
    <div class="white-box">
        ...
        <div class="row">
            <div class="col-sm-12 col-xs-12">
               <form action="manage/khoilop/postUpdate/{{ $khoilop->MaKhoiLop }}" method="post">
               		<input type="hidden" name="_token" value="{{ csrf_Token() }}">
	                <div class="form-group">
	                    <label for="exampleInputEmail1">Mã khối lớp</label>
	                    <input type="text" class="form-control" id="txtMaKhoiLop" name="txtMaKhoiLop" placeholder="" disabled="" value="{{ $khoilop->MaKhoiLop }}">
	                </div>
	                <div class="form-group">
	                    <label for="exampleInputEmail1">Khối lớp</label>
	                    <input type="text" class="form-control" id="txtTenKhoiLop" name="txtTenKhoiLop" placeholder="Nhập tên khối lớp" value="{{ $khoilop->TenKhoiLop }}"> 
	                </div>
