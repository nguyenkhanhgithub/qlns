                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr class="advance-table-row active">
                                        ...
                                        <td style="width: 60px;"><img src="public/back-end/plugins/images/users/varun.jpg" class="img-circle" width="30" alt="user img" /></td>
                                        <td>Andrew Simons</td>
                                        <td>Modulator</td>
                                        <td>6 May 2016</td>
                                        <td>Gujrat, India</td>
                                    ...
                                    <tr class="advance-table-row">
                                        ...
                                        <td><img src="public/back-end/plugins/images/users/genu.jpg" alt="user img" class="img-circle" width="30" /></td>
                                        <td>Hanna Gover</td>
                                        <td>Admin</td>
                                        <td>13 Jan 2005</td>
                                    ...
                                    <tr class="advance-table-row">
                                        ...
                                        <td><img src="public/back-end/plugins/images/users/sonu.jpg" alt="user img" class="img-circle" width="30" /></td>
                                        <td>Joshi Nirav</td>
                                        <td>Admin</td>
                                        <td>21 Mar 2001</td>
                                    ...
                                    <tr class="advance-table-row">
                                        ...
                                        <td><img src="public/back-end/plugins/images/users/pawandeep.jpg" alt="user img" class="img-circle" width="30" /></td>
                                        <td>Joshi Sunil</td>
                                        <td>Admin</td>
                                        <td>21 Mar 2004</td>
                                        <td>Gujarat, India</td>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr class="advance-table-row">
                                        ...
                                        <td style="width: 60px;"><img src="public/back-end/plugins/images/users/varun.jpg" alt="user img" class="img-circle" width="30" /></td>
                                        <td>Andrew Simons</td>
                                        <td>Modulator</td>
                                        <td>6 May 2016</td>
                                        <td>Gujrat, India</td>
...
<div class="row">
    <div class="col-md-6 col-sm-12 col-lg-4">
        <div class="panel">
            <div class="p-30">
                <div class="row">
                    <div class="col-xs-4 col-sm-4"><img src="public/back-end/plugins/images/users/varun.jpg" alt="varun" class="img-circle img-responsive"></div>
            ...
            <div class="p-20 text-center">
                ...
                <ul class="dp-table m-t-30">
                    <li><img src="public/back-end/plugins/images/users/varun.jpg" alt="varun" width="60" data-toggle="tooltip" title="Varun Dhavan" class="img-circle"></li>
                    <li><img src="public/back-end/plugins/images/users/genu.jpg" alt="varun" width="60" data-toggle="tooltip" title="Varun Dhavan" class="img-circle"></li>
                    <li><img src="public/back-end/plugins/images/users/pawandeep.jpg" alt="varun" width="60" data-toggle="tooltip" title="Varun Dhavan" class="img-circle"></li>
            ...
            <div class="panel-footer">
                <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                    <li class="list-group-item" data-role="task">
                        ...
                        <ul class="assignedto">
                            <li><img src="public/back-end/plugins/images/users/1.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Steave" /></li>
                            <li><img src="public/back-end/plugins/images/users/2.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Jessica" /></li>
                            <li><img src="public/back-end/plugins/images/users/3.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Priyanka" /></li>
                            <li><img src="public/back-end/plugins/images/users/4.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Selina" /></li>
                        </ul>
                    </li>
                    <li class="list-group-item" data-role="task">
                        <div class="checkbox checkbox-info">
                    ...
                    <li class="list-group-item" data-role="task">
                        ...
                        <ul class="assignedto">
                            <li><img src="public/back-end/plugins/images/users/1.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Assign to Steave" /></li>
                            <li><img src="public/back-end/plugins/images/users/2.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Assign to Jessica" /></li>
                            <li><img src="public/back-end/plugins/images/users/4.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Assign to Selina" /></li>
                        </ul>
                    </li>
                </ul>
            </div>
...
<!-- ============================================================== -->
<div class="row">
    <div class="col-md-6 col-lg-3 col-xs-12 col-sm-6"> <img class="img-responsive" alt="user" src="public/back-end/plugins/images/big/img1.jpg">
        <div class="white-box">
    ...
    <div class="col-md-6 col-lg-3 col-xs-12 col-sm-6"> <img class="img-responsive" alt="user" src="public/back-end/plugins/images/big/img2.jpg">
        <div class="white-box">
            <div class="text-muted"><span class="m-r-10"><i class="icon-calender"></i> May 16</span> <a class="text-muted m-l-10" href="#"><i class="fa fa-heart-o"></i> 38</a></div>
            <h3 class="m-t-20 m-b-20">Top 20 Models are on the ramp</h3>
            <p>Titudin venenatis ipsum ac feugiat. Vestibulum ullamcorper quam.</p>
    ...
    <div class="col-md-6 col-lg-3 col-xs-12 col-sm-6"> <img class="img-responsive" alt="user" src="public/back-end/plugins/images/big/img3.jpg">
        <div class="white-box">
            <div class="text-muted"><span class="m-r-10"><i class="icon-calender"></i> May 16</span> <a class="text-muted m-l-10" href="#"><i class="fa fa-heart-o"></i> 38</a></div>
            <h3 class="m-t-20 m-b-20">Top 20 Models are on the ramp</h3>
            <p>Titudin venenatis ipsum ac feugiat. Vestibulum ullamcorper quam.</p>
    ...
    <div class="col-md-6 col-lg-3 col-xs-12 col-sm-6"> <img class="img-responsive" alt="user" src="public/back-end/plugins/images/big/img4.jpg">
        <div class="white-box">
            <div class="text-muted"><span class="m-r-10"><i class="icon-calender"></i> May 16</span> <a class="text-muted m-l-10" href="#"><i class="fa fa-heart-o"></i> 38</a></div>
            <h3 class="m-t-20 m-b-20">Top 20 Models are on the ramp</h3>
            <p>Titudin venenatis ipsum ac feugiat. Vestibulum ullamcorper quam.</p>
                    ...
                    <div class="panel-body">
                        <ul class="chatonline">
                            <li>
                                ...
                                <a href="javascript:void(0)"><img src="public/back-end/plugins/images/users/varun.jpg" alt="user-img" class="img-circle"> <span>Varun Dhavan <small class="text-success">online</small></span></a>
                            </li>
                            <li>
                                <div class="call-chat">
                                    <button class="btn btn-success btn-circle btn-lg" type="button"><i class="fa fa-phone"></i></button>
                                ...
                                <a href="javascript:void(0)"><img src="public/back-end/plugins/images/users/genu.jpg" alt="user-img" class="img-circle"> <span>Genelia Deshmukh <small class="text-warning">Away</small></span></a>
                            </li>
                            <li>
                                <div class="call-chat">
                                    <button class="btn btn-success btn-circle btn-lg" type="button"><i class="fa fa-phone"></i></button>
                                ...
                                <a href="javascript:void(0)"><img src="public/back-end/plugins/images/users/ritesh.jpg" alt="user-img" class="img-circle"> <span>Ritesh Deshmukh <small class="text-danger">Busy</small></span></a>
                            </li>
                            <li>
                                <div class="call-chat">
                                    <button class="btn btn-success btn-circle btn-lg" type="button"><i class="fa fa-phone"></i></button>
                                ...
                                <a href="javascript:void(0)"><img src="public/back-end/plugins/images/users/arijit.jpg" alt="user-img" class="img-circle"> <span>Arijit Sinh <small class="text-muted">Offline</small></span></a>
                            </li>
                            <li>
                                <div class="call-chat">
                                    <button class="btn btn-success btn-circle btn-lg" type="button"><i class="fa fa-phone"></i></button>
                                ...
                                <a href="javascript:void(0)"><img src="public/back-end/plugins/images/users/govinda.jpg" alt="user-img" class="img-circle"> <span>Govinda Star <small class="text-success">online</small></span></a>
                            </li>
                            <li>
                                <div class="call-chat">
                                    <button class="btn btn-success btn-circle btn-lg" type="button"><i class="fa fa-phone"></i></button>
                                ...
                                <a href="javascript:void(0)"><img src="public/back-end/plugins/images/users/hritik.jpg" alt="user-img" class="img-circle"> <span>John Abraham<small class="text-success">online</small></span></a>
                            </li>
                            <li>
                                <div class="call-chat">
                                    <button class="btn btn-success btn-circle btn-lg" type="button"><i class="fa fa-phone"></i></button>
        ...
        <div class="panel panel-themecolor">
            ...
            <div class="panel-body">
                <div class="steamline">
                    ...
                    <div class="sl-item">
                        ...
                        <div class="sl-right">
                            ...
                            <div class="row inline-photos">
                                <div class="col-xs-4"><img class="img-responsive" alt="user" src="public/back-end/plugins/images/small/vd1.jpg"></div>
                                <div class="col-xs-4"><img class="img-responsive" alt="user" src="public/back-end/plugins/images/small/vd2.jpg"></div>
                                <div class="col-xs-4"><img class="img-responsive" alt="user" src="public/back-end/plugins/images/small/vd3.jpg"></div>
                            </div>
                        </div>
                    </div>
                    <div class="sl-item">
                        <div class="sl-left"> <img class="img-circle" alt="user" src="public/back-end/plugins/images/users/sonu.jpg"> </div>
                        <div class="sl-right">
                    ...
                    <div class="sl-item">
                        <div class="sl-left"> <img class="img-circle" alt="user" src="public/back-end/plugins/images/users/ritesh.jpg"> </div>
                        <div class="sl-right">
                    ...
                    <div class="sl-item">
                        <div class="sl-left"> <img class="img-circle" alt="user" src="public/back-end/plugins/images/users/govinda.jpg"> </div>
                        <div class="sl-right">
                ...
                <div class="panel-body">
                    <div class="chat-box" style="height: 510px;">
                        <ul class="chat-list slimscroll" style="overflow: hidden;" tabindex="5005">
                            <li>
                                <div class="chat-image"> <img alt="male" src="public/back-end/plugins/images/users/sonu.jpg"> </div>
                                <div class="chat-body">
                                    <div class="chat-text">
                                        <h4>Sonu Nigam</h4>
                            ...
                            <li class="odd">
                                <div class="chat-image"> <img alt="Female" src="public/back-end/plugins/images/users/genu.jpg"> </div>
                                <div class="chat-body">
                                    <div class="chat-text">
                                        <h4>Genelia</h4>
                            ...
                            <li>
                                <div class="chat-image"> <img alt="male" src="public/back-end/plugins/images/users/ritesh.jpg"> </div>
                                <div class="chat-body">
                                    <div class="chat-text">
                                        <h4>Ritesh</h4>
    ...
    <div class="slimscrollright">
        ...
        <div class="r-panel-body">
            ...
            <ul class="m-t-20 chatonline">
                ...
                <li>
                    <a href="javascript:void(0)"><img src="public/back-end/plugins/images/users/john.jpg" alt="user-img" class="img-circle"> <span>Hritik Roshan<small class="text-success">online</small></span></a>
                </li>
                <li>
                    <a href="javascript:void(0)"><img src="public/back-end/plugins/images/users/pawandeep.jpg" alt="user-img" class="img-circle"> <span>Pwandeep rajan <small class="text-success">online</small></span></a>
                </li>
            </ul>
        </div>
    </div>
